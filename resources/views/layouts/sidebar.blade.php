    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="{{ route('user-management.index') }}"><i class="fa fa-link"></i> <span>User management</span></a></li>
         <li><a href="{{ route('task-management.index') }}"><i class="fa fa-link"></i> <span>Task management</span></a></li>
         <li><a href="{{ route('nptask-management.index') }}"><i class="fa fa-link"></i> <span>Non-Productive Task</span></a></li>
         <li><a href="{{ route('timesheet-management.index') }}"><i class="fa fa-link"></i> <span>Timesheet management</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
