...
CREATE TABLE `task` (
  `id` int(10) UNSIGNED NOT NULL,
  `task_name` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `task_type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
)
...
CREATE TABLE `nptask` (
  `id` int(10) UNSIGNED NOT NULL,
  `nptask_name` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `nptask_type` varchar(60) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
)
